    ...
    <main className="mx-auto max-w-2xl bg-stone-50 px-4 py-6">
      ...
      <div className="mt-5 space-y-4">
        <Step mark="①" title="捕獲を報告する">
          ...
          <p>
            写真のあとに、LINEに出てくる<strong>「型」</strong>をコピーして、
            分かるところだけ埋めて<strong>1回で送ってください</strong>。
            空欄のままでも大丈夫です。
          </p>
          <p>型が難しければ、今までどおり1つずつお答えいただいても大丈夫です。</p>
          <p className="rounded-xl bg-stone-100 p-4">
            必要な項目がそろうと、<strong>捕獲票のダウンロードリンク</strong>をお送りします。
            そこから印刷またはPDF保存して、捕獲獣の尾とあわせて市役所へご提出ください。
            リンクは30日間使えます。
          </p>
          <p>
