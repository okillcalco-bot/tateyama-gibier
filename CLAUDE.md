...
## イノシシ肉の出荷制限（全頭検査）解除の状況（千葉県）

東日本大震災後、平成25年1月から千葉県内で捕獲されるイノシシ肉は放射性物質の全頭検査が
義務。県内の市町村ごとに、セシウム濃度が安定して低水準と確認されると順次解除されている。

**解除済み市町村と解除日**（南食検第185号・令和8年8月20日付通知／千葉県報道資料 令和8年7月28日付より）:
- 令和6年7月23日: 勝浦市・大多喜町
- 令和7年10月14日: 茂原市・長柄町・長南町
- 令和8年7月28日: いすみ市・一宮町・睦沢町・御宿町

**館山市・南房総市は上記に含まれておらず、全頭検査は引き続き必須**（今のところ変更なし）。

解除地区で捕獲された個体を全頭検査なしで受け入れる場合の県の条件（「出荷制限解除後の
出荷・検査管理方針」）:
1. 食肉処理業許可＋当方針を遵守する処理加工施設であること
2. 個体識別番号を付し、搬入・処理管理台帳を作成、写しを市町村へ提出
3. 出荷・製品パッケージに個体番号と捕獲地（市町村名）を表示
4. 解除後も概ね1年間は所在市町が原則月1検体以上の検査を継続
5. 基準値超過が判明した場合はその個体を確実に廃棄し、周辺10km圏内は全頭検査に戻す

現状館山ジビエセンターが受け入れる個体はほぼ館山市・南房総市産のため、この解除は当面の
実務には影響しない。今後、解除地区（いすみ市等）からの搬入を受け入れる場合は上記条件の
遵守と台帳・表示対応が必要になる点に注意。
